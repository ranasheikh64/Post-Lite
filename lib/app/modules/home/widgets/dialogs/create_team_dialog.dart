      ...
      builder: (context) => AlertDialog(
        ...
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              const Text(
                'Collaborate with others by creating a team. You can invite members and manage their roles later.',
                style: TextStyle(color: Colors.white70, fontSize: 14),
              ),
              const SizedBox(height: 20),
              const Text('Team Name', style: TextStyle(fontWeight: FontWeight.w500, color: Colors.white70)),
              const SizedBox(height: 8),
              TextField(
                controller: nameController,
                style: const TextStyle(fontSize: 14, color: Colors.white),
                decoration: InputDecoration(
                  hintText: 'e.g. My Awesome Team',
